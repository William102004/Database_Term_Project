...
function displayTransactionDetails(transaction)
{
    ...
    document.getElementById("detail-number").textContent = transaction.TransactionNumber || "--";
}
...
function openEditTransactionModal()
{
    ...
    .then(data => {
        if(data.ok)
        {
            ...
            document.getElementById("edit-transaction-number").value = transaction.TransactionNumber;
